...
const styles = {
  ...
  addBtn: { background: '#3B2E1F', color: '#F2EBDB', border: 'none', borderRadius: 8, padding: '10px 16px', fontWeight: 'bold', cursor: 'pointer' },

  successBanner: { background: '#1e3a24', color: '#4C7A52', border: '1px solid #2d5636', borderRadius: 10, padding: '10px 16px', marginBottom: 16, fontSize: 13.5 },
  errorBanner: { background: '#3a1e1e', color: '#C97A6E', border: '1px solid #D9B9AE', borderRadius: 10, padding: '10px 16px', marginBottom: 16, fontSize: 13.5 },
  ...
  confirmBox: {
    background: '#FBF8F0', border: '1px solid #C7B689', borderRadius: 14, padding: 24, maxWidth: 380, width: '100%',
  },
  confirmTitle: { fontSize: 17, fontWeight: 'bold', margin: '0 0 10px', color: '#2E2618' },
  confirmText: { fontSize: 13.5, color: '#8A7A56', margin: '0 0 20px', lineHeight: 1.5 },
  ...
  form: { background: '#FBF8F0', border: '1px solid #DACC9E', borderRadius: 12, padding: 20, marginBottom: 24 },
  formTitle: { margin: '0 0 16px', fontSize: 15, fontWeight: 'bold', color: '#3B2E1F' },
  marginPreview: { color: '#4C7A52', fontSize: 12.5, margin: '-6px 0 14px', fontStyle: 'italic' },
  formRow: { display: 'flex', gap: 12, marginBottom: 14, flexWrap: 'wrap' },
  fieldCol: { flex: 1, minWidth: 160 },
  fieldLabel: { display: 'block', fontSize: 11.5, color: '#8A7A56', marginBottom: 5, textTransform: 'uppercase', letterSpacing: 0.4 },
  input: { width: '100%', background: '#EAE0C7', color: '#2E2618', border: '1px solid #C7B689', borderRadius: 8, padding: '10px 12px', fontSize: 14, boxSizing: 'border-box' },

  variantBuilder: { background: '#EFE6D5', border: '1px dashed #C7B689', borderRadius: 10, padding: 16, marginBottom: 14 },
  variantBuilderTitle: { margin: '0 0 12px', fontSize: 13.5, color: '#5C4E36', fontWeight: 600 },
  quickRow: { display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 14 },
  quickChip: { background: '#EAE0C7', border: '1px solid #C7B689', color: '#2E2618', borderRadius: 999, padding: '7px 14px', fontSize: 13, cursor: 'pointer' },
  quickChipActive: { background: '#3B2E1F', border: '1px solid #3B2E1F', color: '#F2EBDB', borderRadius: 999, padding: '7px 14px', fontSize: 13, cursor: 'pointer', fontWeight: 700 },

  rowsList: { marginBottom: 10 },
  rowsHeader: { display: 'flex', gap: 8, fontSize: 11, color: '#8A7A56', textTransform: 'uppercase', letterSpacing: 0.4, marginBottom: 6, padding: '0 2px' },
  ...
  muted: { color: '#8A7A56' },
  saveBtn: { background: '#3B2E1F', color: '#F2EBDB', border: 'none', borderRadius: 8, padding: '10px 20px', fontWeight: 'bold', cursor: 'pointer' },

  list: { display: 'flex', flexDirection: 'column', gap: 10 },
  card: { background: '#FBF8F0', border: '1px solid #DACC9E', borderRadius: 10, overflow: 'hidden' },
  ...
  thumbPlaceholder: { width: 48, height: 48, borderRadius: 8, background: '#EAE0C7', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20 },
  cardName: { fontWeight: 'bold', fontSize: 15 },
  cardMeta: { color: '#8A7A56', fontSize: 12.5, marginTop: 2 },
  cardRight: { display: 'flex', alignItems: 'center', gap: 14 },
  cardPrice: { color: '#3B2E1F', fontWeight: 'bold' },
  expandIcon: { color: '#8A7A56', fontSize: 11 },

  cardExpand: { padding: '4px 18px 16px', borderTop: '1px solid #DACC9E' },
  detailBox: { background: '#EFE6D5', border: '1px solid #DACC9E', borderRadius: 10, padding: '12px 14px', margin: '12px 0 4px' },
  detailRow: { display: 'flex', justifyContent: 'space-between', fontSize: 12.5, marginBottom: 6, color: '#5C4E36' },
  detailLabel: { color: '#8A7A56' },
  gainValue: { color: '#4C7A52', fontWeight: 600 },
  detailDescription: { fontSize: 12.5, color: '#7A6B4D', lineHeight: 1.5, marginTop: 6, borderTop: '1px solid #DACC9E', paddingTop: 8 },
  variantTable: { marginTop: 10, marginBottom: 12 },
  variantRow: { display: 'flex', alignItems: 'center', gap: 10, padding: '8px 0', borderBottom: '1px solid #DACC9E', fontSize: 13 },
  stockOk: { color: '#4C7A52', width: 90 },
  stockLow: { color: '#B5574A', width: 90 },
  variantPrice: { color: '#3B2E1F', width: 70, fontWeight: 600 },
  deleteVariantBtn: { background: 'transparent', border: '1px solid #C7B689', color: '#B5574A', borderRadius: 7, padding: '5px 10px', fontSize: 11.5, cursor: 'pointer' },

  cardActions: { display: 'flex', gap: 10, flexWrap: 'wrap' },
  smallActionBtn: { background: '#EAE0C7', border: '1px solid #C7B689', color: '#2E2618', borderRadius: 8, padding: '8px 14px', fontSize: 12.5, cursor: 'pointer' },
  deleteProductBtn: { background: 'transparent', border: '1px solid #D9B9AE', color: '#B5574A', borderRadius: 8, padding: '8px 14px', fontSize: 12.5, cursor: 'pointer' },

  addVariantBox: { display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center', background: '#EFE6D5', border: '1px dashed #C7B689', borderRadius: 10, padding: 12 },
  saveBtnSmall: { background: '#3B2E1F', color: '#F2EBDB', border: 'none', borderRadius: 7, padding: '8px 14px', fontSize: 12.5, fontWeight: 700, cursor: 'pointer' },
  cancelBtnSmall: { background: 'transparent', border: '1px solid #C7B689', color: '#8A7A56', borderRadius: 7, padding: '8px 14px', fontSize: 12.5, cursor: 'pointer' },

  imageUploadBox: { display: 'flex', alignItems: 'center', gap: 12 },
  imagePreview: { width: 40, height: 40, borderRadius: 8, objectFit: 'cover', border: '1px solid #C7B689' },
  imagePlaceholder: { width: 40, height: 40, borderRadius: 8, background: '#EAE0C7', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 9, color: '#8A7A56', textAlign: 'center' },
  uploadLabel: { background: '#EAE0C7', color: '#2E2618', border: '1px solid #C7B689', borderRadius: 8, padding: '8px 14px', fontSize: 12.5, cursor: 'pointer' },
}
